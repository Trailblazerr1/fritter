...
class UserTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      title: Row(
        children: [
          Text(name, style: TextStyle (color: Colors.black, fontWeight: FontWeight.w500, fontSize: 15.0)),
          if (verified)
            SizedBox(width: 6),
          if (verified)
      ...
      subtitle: Text('@$screenName', style: TextStyle (color: Colors.black, fontWeight: FontWeight.w500, fontSize: 12.0 )),
      trailing: Container(
        width: 36,
